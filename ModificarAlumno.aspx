...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <!-- Tu formulario de carga de alumno aquí -->
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-8 mb-3">
                            <label for="txtBuscarAlumno" class="form-label small fw-medium">
                                Buscar por nombre, apellido o documento</label>
                            <asp:TextBox ID="txtBuscarAlumno" runat="server" CssClass="form-control" placeholder="Ingrese nombre, apellido o documento"></asp:TextBox>
                        </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h6 class="section-title mb-0 text-uppercase small fw-bold text-blue">
                                <i class="fas fa-user-circle me-2"></i>Editando:
                                <asp:Label ID="lblAlumnoSeleccionado" runat="server" CssClass="text-dark"></asp:Label>
                            </h6>
                        ...
                        <div class="form-container">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvDocumento" runat="server" ControlToValidate="txtDocumento"
                                            ErrorMessage="Requerido" Display="Dynamic" CssClass="text-danger small"></asp:RequiredFieldValidator>
                                        <!-- Validación de longitud para DNI (8 caracteres) -->
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <asp:TextBox ID="txtDireccion" runat="server" CssClass="form-control" TextMode="MultiLine"
                                            Rows="3" placeholder="Dirección completa"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <!-- Línea divisoria -->
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <!-- Validación de longitud para teléfono (10 caracteres) -->
                            ...
                            <div class="d-grid gap-3 d-md-flex justify-content-center mt-5 pt-3">
                                ...
                                <asp:Button ID="btnActualizar" runat="server" Text="Actualizar Datos" CssClass="btn btn-primary px-4 py-2"
                                    OnClick="btnActualizar_Click" />
                                <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn btn-danger px-4 py-2"
