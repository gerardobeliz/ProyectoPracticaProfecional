...
namespace proyectoPracticaProfecional
{
    public partial class ModificarAlumno : System.Web.UI.Page
    {
        ...
        private DataTable BuscarAlumnos(string criterio)
        {
            ...
            {
                // CORREGIDO: Usar parámetros para evitar inyección SQL
                string script = @"SELECT LEGAJO, nombre, apellido, dni 
                          FROM Alumnos 
                ...
                {
                    // CORREGIDO: Usar parámetro en lugar de concatenar
                        ...
                        if (reader.HasRows)
                        {
                            while (reader.Read())
                            {
                                ...
                                dt.Rows.Add(
                                    ...
                                    "", // Curso (si no está en la consulta)
                                    ""  // Email (si no está en la consulta)
                                );
                            }
                        }
                    }
            ...
            return dt; // Siempre devuelve el DataTable (vacío si no hay resultados)
        }
